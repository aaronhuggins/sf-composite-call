...
* [CompositeCall](#CompositeCall)
    ...
    * [.execute([connection])](#CompositeCall+execute) ⇒ <code>Promise.&lt;CompositeCallResponse&gt;</code>
...
### compositeCall.execute([connection]) ⇒ <code>Promise.&lt;CompositeCallResponse&gt;</code>
<p>Convenience method for integrating with JSforce.</p>

**Kind**: instance method of [<code>CompositeCall</code>](#CompositeCall)  
**Returns**: <code>Promise.&lt;CompositeCallResponse&gt;</code> - <ul>
<li>The result of executing the composite call, or undefined if no JSforce connection was given.</li>
</ul>  

| Param | Type | Description |
| --- | --- | --- |
| [connection] | <code>any</code> | <p>Optionally pass a JSforce connection instance; used if not defined as part this class instance options.</p> |
...
* [CompositeSubrequestSObjectCollection](#CompositeSubrequestSObjectCollection) ⇐ [<code>CompositeSubrequest</code>](#CompositeSubrequest)
    ...
    * [.update(record, [sobjectOrExternalIdRef], [allOrNone], [httpHeaders])](#CompositeSubrequestSObjectCollection+update) ⇒ <code>CompositeSubrequestBody</code>
...
### compositeSubrequestSObjectCollection.update(record, [sobjectOrExternalIdRef], [allOrNone], [httpHeaders]) ⇒ <code>CompositeSubrequestBody</code>
...
| [sobjectOrExternalIdRef] | <code>string</code> \| <code>ExternalIdReference</code> | <p><strong>Optional, if all records have a type; required for external ID upserts.</strong> A SObject name; used to add type information to any records missing <code>attributes.type</code>.</p> |
